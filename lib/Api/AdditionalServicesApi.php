...
class AdditionalServicesApi
{
     ...
     *
     * @param  \Swagger\Client\Model\AdditionalServicesGroupRequest $body Additional service group body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\AdditionalServicesGroupResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\AdditionalServicesGroupResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAdditionalServicesGroupUsingPOSTWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\AdditionalServicesGroupResponse';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\AdditionalServicesGroupResponse',
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\DefinitionsResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\DefinitionsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getListOfAdditionalServicesDefinitionsUsingGETWithHttpInfo($offset = '0', $limit = '100')
    {
        $returnType = '\Swagger\Client\Model\DefinitionsResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\DefinitionsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getListOfAdditionalServicesDefinitionsUsingGETRequest($offset = '0', $limit = '100')
    {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\AdditionalServicesGroups
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\AdditionalServicesGroups, HTTP status code, HTTP response headers (array of strings)
     */
    public function getListOfAdditionalServicesGroupsUsingGETWithHttpInfo($offset = '0', $limit = '100')
    {
        $returnType = '\Swagger\Client\Model\AdditionalServicesGroups';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\AdditionalServicesGroups',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
