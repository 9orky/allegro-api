...
class ClassifiedsApi
{
     ...
     *
     * @param  \Swagger\Client\Model\ClassifiedPackages $body Packages that should be assigned to the classified. (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ClassifiedPackageConfig
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ClassifiedPackageConfig, HTTP status code, HTTP response headers (array of strings)
     */
    public function getClassifiedPackageConfigurationUsingGETWithHttpInfo($package_id)
    {
        $returnType = '\Swagger\Client\Model\ClassifiedPackageConfig';
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ClassifiedPackageConfigs
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ClassifiedPackageConfigs, HTTP status code, HTTP response headers (array of strings)
     */
    public function getClassifiedPackageConfigurationsForCategoryUsingGETWithHttpInfo($category_id)
    {
        $returnType = '\Swagger\Client\Model\ClassifiedPackageConfigs';
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ClassifiedResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ClassifiedResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getClassifiedPackagesUsingGETWithHttpInfo($offer_id)
    {
        $returnType = '\Swagger\Client\Model\ClassifiedResponse';
