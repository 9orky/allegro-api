...
class CommissionRefundsApi
{
     ...
     *
     * @param  \Swagger\Client\Model\RefundClaimRequest $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
    ...
    {
        $this->createRefundApplicationWithHttpInfo($body);
    }
     ...
     * Create a refund application
     *
     * @param  \Swagger\Client\Model\RefundClaimRequest $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\RefundClaim
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\RefundClaim, HTTP status code, HTTP response headers (array of strings)
     */
    public function getRefundApplicationWithHttpInfo($claim_id)
    {
        $returnType = '\Swagger\Client\Model\RefundClaim';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\RefundClaim',
