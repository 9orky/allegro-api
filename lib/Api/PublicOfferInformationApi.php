...
class PublicOfferInformationApi
{
     ...
     * @return \Swagger\Client\Model\ListingResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ListingResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Swagger\Client\Model\ListingResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ListingResponse',
     ...
     */
    protected function getListingRequest($category_id = null, $phrase = null, $seller_id = null, $seller_login = null, $search_mode = 'REGULAR', $offset = '0', $limit = '60', $sort = 'relevance', $include = null, $fallback = 'true', $dynamic_filters = null)
    {
