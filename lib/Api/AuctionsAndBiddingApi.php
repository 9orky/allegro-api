...
class AuctionsAndBiddingApi
{
     ...
     * @return \Swagger\Client\Model\MyBidResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\MyBidResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBidWithHttpInfo($offer_id)
    {
        $returnType = '\Swagger\Client\Model\MyBidResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\MyBidResponse',
     ...
     *
     * @param  string $offer_id The offer ID. (required)
     * @param  \Swagger\Client\Model\BidRequest $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\MyBidResponse
     ...
     *
     * @param  string $offer_id The offer ID. (required)
     * @param  \Swagger\Client\Model\BidRequest $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\MyBidResponse, HTTP status code, HTTP response headers (array of strings)
