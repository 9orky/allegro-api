...
class DisputesApi
{
     ...
     *
     * @param  \Swagger\Client\Model\MessageRequest $body Message request (required)
     * @param  string $dispute_id Dispute identifier. (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\DisputeMessage
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\DisputeMessage, HTTP status code, HTTP response headers (array of strings)
     */
    public function addMessageToDisputeUsingPOSTWithHttpInfo($body, $dispute_id)
    {
        $returnType = '\Swagger\Client\Model\DisputeMessage';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\DisputeMessage',
     ...
     *
     * @param  \Swagger\Client\Model\AttachmentDeclaration $body A detailed declaration of a file to be uploaded (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\DisputeAttachmentId
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\DisputeAttachmentId, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAnAttachmentUsingPOSTWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\DisputeAttachmentId';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\DisputeAttachmentId',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\Dispute, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDisputeUsingGETWithHttpInfo($dispute_id)
    {
        $returnType = '\Swagger\Client\Model\Dispute';
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\DisputeListResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\DisputeListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getListOfDisputesUsingGETWithHttpInfo($checkout_form_id = null, $limit = '10', $offset = '0')
    {
        $returnType = '\Swagger\Client\Model\DisputeListResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\DisputeListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\DisputeMessageList
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\DisputeMessageList, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMessagesFromDisputeUsingGETWithHttpInfo($dispute_id, $limit = '10', $offset = '0')
    {
        $returnType = '\Swagger\Client\Model\DisputeMessageList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\DisputeMessageList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
