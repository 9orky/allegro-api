...
class BlacklistManagementApi
{
     ...
     *
     * @param  \Swagger\Client\Model\BlacklistRequest $body request (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\BlackListResponse
     */
    public function doAddToBlackList($body)
    {
        list($response) = $this->doAddToBlackListWithHttpInfo($body);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\BlackListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function doAddToBlackListWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\BlackListResponse';
        $request = $this->doAddToBlackListRequest($body);
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\BlackListResponse',
     ...
     */
    public function doAddToBlackListAsync($body)
    {
        return $this->doAddToBlackListAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function doAddToBlackListAsyncWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\BlackListResponse';
        $request = $this->doAddToBlackListRequest($body);
     ...
     */
    protected function doAddToBlackListRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling doAddToBlackList'
            );
        }
