...
class PublicUserInformationApi
{
     ...
     * @return \Swagger\Client\Model\UserRatingSummaryResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\UserRatingSummaryResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getUserSummaryUsingGETWithHttpInfo($user_id)
    {
        $returnType = '\Swagger\Client\Model\UserRatingSummaryResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\UserRatingSummaryResponse',
