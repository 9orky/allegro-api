...
class AllegroPricesApi
{
     ...
     * @return \Swagger\Client\Model\AllegroPricesConsentChangeResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\AllegroPricesConsentChangeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllegroPricesConsentForOfferWithHttpInfo($offer_id)
    {
        $returnType = '\Swagger\Client\Model\AllegroPricesConsentChangeResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\AllegroPricesConsentChangeResponse',
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\AllegroPricesEligibilityResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\AllegroPricesEligibilityResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllegroPricesEligibilityForAccountWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\AllegroPricesEligibilityResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\AllegroPricesEligibilityResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Swagger\Client\Model\AllegroPricesChangeRequest $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\AllegroPricesConsentChangeResponse
     ...
     * Update consent value for the account
     *
     * @param  \Swagger\Client\Model\AllegroPricesChangeRequest $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\AllegroPricesConsentChangeResponse, HTTP status code, HTTP response headers (array of strings)
