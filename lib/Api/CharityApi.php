...
class CharityApi
{
     ...
     * @return \Swagger\Client\Model\FundraisingCampaigns
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\FundraisingCampaigns, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchFundraisingCampaignsWithHttpInfo($limit, $phrase)
    {
        $returnType = '\Swagger\Client\Model\FundraisingCampaigns';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\FundraisingCampaigns',
