...
class SizeTablesApi
{
     ...
     * Create a size table
     *
     * @param  \Swagger\Client\Model\SizeTablePostRequest $body Size table details (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\PublicTableDto
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\PublicTableDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function createTableUsingPOSTWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\PublicTableDto';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\PublicTableDto',
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\SizeTableTemplatesResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\SizeTableTemplatesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTablesTemplatesUsingGETWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\SizeTableTemplatesResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\SizeTableTemplatesResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\PublicTablesDto
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\PublicTablesDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTablesUsingGETWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\PublicTablesDto';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\PublicTablesDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Update a size table
     *
     * @param  \Swagger\Client\Model\SizeTablePutRequest $body Size table details (required)
     * @param  string $table_id Table identifier. (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
