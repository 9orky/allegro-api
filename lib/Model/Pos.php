...
class Pos implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Pos';
...
'phone_number' => 'string',
'email' => 'string',
'open_hours' => '\Swagger\Client\Model\OpenHour[]',
'service_time' => 'string',
...
'updated_at' => 'getUpdatedAt'    ];
     ...
     * Gets open_hours
     *
     * @return \Swagger\Client\Model\OpenHour[]
     */
     ...
     * Sets open_hours
     *
     * @param \Swagger\Client\Model\OpenHour[] $open_hours Possible empty list of opening hours.
     *
     * @return $this
     */
     ...
     * Sets payments
     *
     * @param \Swagger\Client\Model\Payment[] $payments An empty list of payment types is available.
     *
     * @return $this
     */
     ...
     * Sets created_at
     *
     * @param string $created_at Creation date. Date format (ISO 8601) - yyyy-MM-dd'T'HH:mm:ss.SSSZ When creating (Post) or updating (Put) a point of service (Post) the field is ignored.
     *
     * @return $this
     */
     ...
     * Sets updated_at
     *
     * @param string $updated_at Modification date. Date format (ISO 8601) - yyyy-MM-dd'T'HH:mm:ss.SSSZ When creating (Post) or updating (Put) a point of service (Post) the field is ignored.
     *
     * @return $this
     */
