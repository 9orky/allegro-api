 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExtendedTax implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ExtendedTax';
...
'percentage' => 'getPercentage'    ];
     ...
     * Sets id
     *
     * @param string $id A unique identifier of an immutable VAT setting consisting of rate, subject and exemption.
     *
     * @return $this
     */
     ...
     * Sets percentage
     *
     * @param string $percentage The tax rate. This field is deprecated in favor of `rate`. Format `0.00`.
     *
     * @return $this
     */
