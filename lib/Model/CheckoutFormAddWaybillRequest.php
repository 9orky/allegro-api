...
class CheckoutFormAddWaybillRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CheckoutFormAddWaybillRequest';
...
'waybill' => 'string',
'carrier_name' => 'string',
'line_items' => '\Swagger\Client\Model\CheckoutFormAddWaybillRequestLineItems[]'    ];
...
'line_items' => 'getLineItems'    ];
     ...
     * Gets line_items
     *
     * @return \Swagger\Client\Model\CheckoutFormAddWaybillRequestLineItems[]
     */
     ...
     * Sets line_items
     *
     * @param \Swagger\Client\Model\CheckoutFormAddWaybillRequestLineItems[] $line_items List of order line items. They must be from the order specified in the path parameter. When list is not provided or it is empty it means that every item from an order is included in shipment.
     *
     * @return $this
     */
