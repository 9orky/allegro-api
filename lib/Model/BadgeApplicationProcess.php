...
class BadgeApplicationProcess implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BadgeApplicationProcess';
    ...
    protected static $swaggerTypes = [
        'status' => 'string',
'rejection_reasons' => '\Swagger\Client\Model\BadgeApplicationRejectionReason[]'    ];
...
self::STATUS_DECLINED,        ];
     ...
     *
     * @return \Swagger\Client\Model\BadgeApplicationRejectionReason[]
     */
     ...
     *
     * @param \Swagger\Client\Model\BadgeApplicationRejectionReason[] $rejection_reasons A list of rejection reasons for the badge application. Returned for process.status = DECLINED only.
     *
     * @return $this
     */
