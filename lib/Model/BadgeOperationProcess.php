...
class BadgeOperationProcess implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BadgeOperationProcess';
...
self::STATUS_DECLINED,        ];
     ...
     *
     * @param \Swagger\Client\Model\BadgeApplicationRejectionReason[] $rejection_reasons A list of rejection reasons for the badge operation. Returned for process.status = DECLINED only.
     *
     * @return $this
     */
