...
class AvailablePromotionPackages implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AvailablePromotionPackages';
    ...
    protected static $swaggerTypes = [
        'base_packages' => '\Swagger\Client\Model\AvailablePromotionPackage[]',
'extra_packages' => '\Swagger\Client\Model\AvailablePromotionPackage[]'    ];
...
'extra_packages' => 'getExtraPackages'    ];
     ...
     * Gets base_packages
     *
     * @return \Swagger\Client\Model\AvailablePromotionPackage[]
     */
     ...
     * Sets base_packages
     *
     * @param \Swagger\Client\Model\AvailablePromotionPackage[] $base_packages Available base promotion packages. Only one base package can be set on an offer.
     *
     * @return $this
     */
     ...
     * Sets extra_packages
     *
     * @param \Swagger\Client\Model\AvailablePromotionPackage[] $extra_packages Available extra promotion packages. Multiple different extra packages can be set on an offer.
     *
     * @return $this
     */
