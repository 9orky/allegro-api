...
class BadgeProcess implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BadgeProcess';
...
self::STATUS_DECLINED,        ];
     ...
     *
     * @param \Swagger\Client\Model\BadgeApplicationRejectionReason[] $rejection_reasons A list of messages with rejection reasons. Returned for process.status = DECLINED only.
     *
     * @return $this
     */
