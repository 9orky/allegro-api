...
class SmartOfferClassificationReportConditions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SmartOfferClassificationReport_conditions';
...
'description' => 'string',
'fulfilled' => 'bool',
'passed_delivery_methods' => '\Swagger\Client\Model\DeliveryMethodId[]',
'failed_delivery_methods' => '\Swagger\Client\Model\DeliveryMethodId[]'    ];
...
'failed_delivery_methods' => 'getFailedDeliveryMethods'    ];
     ...
     *
     * @return \Swagger\Client\Model\DeliveryMethodId[]
     */
     ...
     *
     * @param \Swagger\Client\Model\DeliveryMethodId[] $passed_delivery_methods Set of delivery methods that meet this condition. May be null if the condition does not apply to delivery methods.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\DeliveryMethodId[] $failed_delivery_methods Set of delivery methods that fail to meet this condition. May be null if the condition does not apply to delivery methods.
     *
     * @return $this
     */
